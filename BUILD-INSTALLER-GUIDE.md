# Guía para Generar el Instalador v1.1.5

## ✅ Estado Actual

Todos los cambios de código para la versión 1.1.5 están completos:
...
├── SINDESCOL-Setup-1.1.5.exe      # Instalador completo (~150 MB)
...
1. **Crear un nuevo release en GitHub:**
   ...
   - Tag version: `v1.1.5`
   - Release title: `SINDESCOL v1.1.5 - Sistema de Notificaciones Mejorado`
   - Descripción: Copia el contenido de `CHANGELOG-1.1.5.md`

2. **Subir los instaladores:**
   - Arrastra el archivo `SINDESCOL-Setup-1.1.5.exe`
...
- Los usuarios con v1.0.5 recibirán notificación de actualización automáticamente
...
1. **Probar el instalador:**
   - Ejecuta `SINDESCOL-Setup-1.1.5.exe`
...
2. **Verificar características nuevas:**
   ...
   - Confirma que la versión en Sidebar es 1.1.5

3. **Probar auto-actualización (opcional):**
   - Instala v1.0.4 en una VM o PC de prueba
   - Publica el release v1.1.5 en GitHub
...
**¿Necesitas ayuda?** Revisa el [CHANGELOG-1.1.5.md](./CHANGELOG-1.1.5.md) para ver todos los cambios implementados.
